 ...
 <body>
    ...
    <header class="navbar navbar-dark bg-dark sticky-top">
          ...
          <ul class="nav col-12 col-lg-auto mx-5 my-2 justify-content-center my-md-0 text-small border-bottom mb-3">
            <li>
              <a href="/EcomerceLivroLES/adm-home" class="nav-link text-secondary">
	...
	<main class="container">
     	 ...
     	 <h1 class="display-4 fw-normal text-center py-2">Selecione uma ação </h1>   
		...
		<div class="row text-center">
	      ...
	      <div class="col">
	        <div class="card mb-4 rounded-3 shadow-sm">
	          <div class="card-body text-center">
	            <a href="/EcomerceLivroLES/adm-grafico">
	              <svg class="bi d-block mx-auto mb-1" width="150" height="150"><use xlink:href="#speedometer2"></use></svg>
	            </a>
	            <h4 class="my-0 fw-normal">Visualizar Gráfico</h4>
	          </div>
	        </div>
	      </div>
	       ...
	       <div class="col">
	        <div class="card mb-4 rounded-3 shadow-sm">
	          <div class="card-body text-center">
	            <a href="/EcomerceLivroLES/adm-pedidos">
	              <svg class="bi d-block mx-auto mb-1" width="150" height="150"><use xlink:href="#table"></use></svg>
	            </a>
	            <h4 class="my-0 fw-normal">Consultar Pedidos</h4>
	          </div>
	        </div>
	      </div>
	      ...
	      <div class="col">
	        <div class="card mb-4 rounded-3 shadow-sm">
	          <div class="card-body text-center">
	            <a href="/EcomerceLivroLES/adm-pedidos-troca">
	              <svg class="bi d-block mx-auto mb-1" width="150" height="150"><use xlink:href="#table"></use></svg>
	            </a>
	            <h4 class="my-0 fw-normal">Solicitações de Troca</h4>
	          </div>
	        </div>
	      </div>
	       ...
	       <div class="col">
	        <div class="card mb-4 rounded-3 shadow-sm">
	          <div class="card-body text-center">
	            <a href="/EcomerceLivroLES/adm-estoque">
	              <svg class="bi d-block mx-auto mb-1" width="150" height="150"><use xlink:href="#grid"></use></svg>
	            </a>
	            <h4 class="my-0 fw-normal">Consultar Estoque</h4>
	          </div>
	        </div>
	      </div>
	       ...
	       <div class="col">
	        <div class="card mb-4 rounded-3 shadow-sm">
	          <div class="card-body text-center">
	            <a href="/EcomerceLivroLES/adm-clientes">
	               <svg class="bi d-block mx-auto mb-1" width="150" height="150"><use xlink:href="#people-circle"></use></svg>
	             </a>
	             <h4 class="my-0 fw-normal"> Consultar Clientes </h4>
	          </div>
	        </div>
	      </div>
