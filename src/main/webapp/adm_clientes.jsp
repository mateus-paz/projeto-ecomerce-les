...
<%@page import= "java.util.List, dominio.cliente.Cliente, dominio.cliente.Genero"%>    
  ...
  <!DOCTYPE html>
    ...
    <header class="navbar navbar-dark bg-dark sticky-top">
          ...
          <ul class="nav col-12 col-lg-auto mx-5 my-2 justify-content-center my-md-0 text-small border-bottom mb-3">
            ...
            <li>
              <a href="/EcomerceLivroLES/adm-clientes" class="nav-link text-secondary">
          ...
          <main class="container">
                ...
                <h1 class="display-4 fw-normal text-center py-2">Clientes Cadastrados </h1>   
         
     	 		<hr>   
     	 
              <div class="row">
              
              <table class="table display" id="table_clientes">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" class="text-center">Perfil detalhado</th>
                      </tr>
                    </thead>
                          ...
                          for(Cliente cliente: clientes){%>
                            ...
                            <tr>
                             ...
                             <td class="text-center align-middle">
                              ...
                              <td class="text-center align-middle">
                                <%=cliente.getTelefone().getDdd()+" "+cliente.getTelefone().getNumero()%>
                              </td>     
                                        
                              <td>
	                              <form action="/EcomerceLivroLES/adm-cliente-detalhes" method="post">
