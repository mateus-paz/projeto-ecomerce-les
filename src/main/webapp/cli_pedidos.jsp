<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import= "java.util.List, dominio.venda.Pedido, dominio.venda.StatusPedido, java.time.LocalDate, java.time.format.DateTimeFormatter"%>
  ...
  <main class="container">
        ...
        <div class="row align-items-md-center">
            ...
            <div class="col-3">
            	<form action="/EcomerceLivroLES/cli-pedidos-troca" method="post">
            		<input type="hidden" name="operacao" value="Consultar">
            		<button type="submit" class="btn">Visulisar Trocas Solicitadas</button>
            	</form>
           	</div>
	            ...
	            <tbody>
	              ...
	              <tr>
	                ...
	                <td class="text-center align-middle">
	                  ...
	                  <form action="/EcomerceLivroLES/cli-pedido-detalhes" method="post">
