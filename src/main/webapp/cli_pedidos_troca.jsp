<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import= "java.util.List, dominio.venda.Pedido, dominio.venda.PedidoTroca, dominio.venda.StatusPedido, java.time.LocalDate, java.time.format.DateTimeFormatter"%>
...
<head>
  ...
  <%
    List<PedidoTroca> pedidos = (List<PedidoTroca>) request.getSession().getAttribute("pedidos");
  %>
</head>
<body>
  ...
  <main class="container">
        ...
        <div class="row align-items-md-center">
            <div class="col-9">
        		<h2>Suas Solicitações de Troca</h2>
        	</div>
            
            <div class="col-3">
            	<form action="/EcomerceLivroLES/cli-pedidos" method="post">
            		<input type="hidden" name="operacao" value="Consultar">
            		<button type="submit" class="btn">Visualizar Todos os pedidos</button>
            	</form>
           	</div>
        </div>
      ...
      <hr>
       ...
       <div class="row">
          	...
          	<table class="table display" id="table_pedidos">
	            ...
	            <tbody>
	              <% if(pedidos!= null)
	              for(PedidoTroca pedido : pedidos){%>
	              <tr>
	                <td class="text-center align-middle"><%=pedido.getId()%></td>
	                <td class="text-center align-middle"><%=pedido.getDtCadastro().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"))%></td>
	                <td class="text-center align-middle"><%=pedido.getPedido().getStatus().getDescricao()%></td>
	                <td class="text-center align-middle">
	                  ...
	                  <form action="/EcomerceLivroLES/cli-pedido-troca-detalhes" method="post">
	                    ...
	                    <button class="btn btn-danger" name="operacao" value="ConsultarPorId">Mais Detalhes</button>
	                  </form>
					  </div>        
	                </td>
	              </tr>
