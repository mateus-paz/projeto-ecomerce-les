...
<%@page import= "java.util.List, dominio.livro.Livro,dominio.livro.Autor,dominio.livro.Categoria, dominio.venda.ItemEstoque,
dominio.venda.Estoque"%>   
...
<body>
    ...
    <header class="navbar navbar-dark bg-dark sticky-top">
          ...
          <ul class="nav col-12 col-lg-auto mx-5 my-2 justify-content-center my-md-0 text-small border-bottom mb-3">
            ...
            <li>
           	  <a href="/EcomerceLivroLES/adm-estoque" class="nav-link text-secondary">
          ...
          <main class="container">
            ...
            <h1 class="display-4 fw-normal text-center py-2">Estoque de Produtos </h1>   
    
	 		<hr>  
              
              
              <table class="table display" id="table_estoque">
                    <thead>
                      <tr>
                        <th scope="col" class="text-center">Nome do Livro</th>
                        <th scope="col" class="text-center">Autor(es)</th>
                        <th scope="col" class="text-center">Editora</th>
                        <th scope="col" class="text-center">Status</th>
                        <th scope="col" class="text-center">Quantidade Disponivel</th>
                        <th scope="col" class="text-center">Informações Detalhadas</th>
                      </tr>
                    </thead>
                    <tbody>
                      <% if(estoque != null){
                          for(ItemEstoque item: estoque.getItens()){%>
                            ...
                            <tr>
                              ...
                              <td class="text-center align-middle">
                               <%
		              				for(Autor a : item.getLivro().getAutores()){
		              					out.print(a.getNome());
		              					out.print("; ");
                             ...
                             <td class="text-center align-middle">
                              ...
                              <td class="text-center align-middle">
                              <form action="/EcomerceLivroLES/adm-item-detalhes" method="post">
