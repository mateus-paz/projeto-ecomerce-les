...
<body class="text-center">
	...
	<div class="position-absolute top-50 start-50 translate-middle">
		...
		<div class="form-signin w-100 m-auto">	
	        <form class="form-container" action="/EcomerceLivroLES/autenticar" method="post">
	            ...
	            <div class="form-floating">
	                <input type="password" class="form-control" id="floatingPassword" name="txtSenha" placeholder="Password" 
	                    minlength="8" autocomplete="off" required>
	                <label for="floatingPassword">Senha</label>
	            </div>
	            
	            <button type="submit" class="w-100 btn btn-lg btn-primary" name="operacao" value="Consultar">
	                Entrar
	            </button>
	        ...
	        <p class="text-secondary">Ou entao... </p>
		     ...
		     <button type="button" class="btn btn-secundary" data-bs-toggle="modal" data-bs-target="#modalCadastro">
    ...
    <div class="modal fade" id="modalCadastro" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="row g-3" action="/EcomerceLivroLES/cli-cadastrar" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row py-1">
                                <div class="col-sm-12">
                                    <label class="visually-hidden" for="txtNome">Nome Completo</label>
                            ...
                            <div class="row py-1">
                                ...
                                <div class="col-sm-4">
                                    <label class="visually-hidden" for="cbbGenero">Genero</label>
                                    <select class="form-select" id="cbbGenero" name="cbbGenero">
                                        <option value="0" selected>Selecione seu Genero...</option>
                            ...
                            <div class="row py-1">
                                <div class="col-sm-6">
                                    <label class="visually-hidden" for="cbbTpTelefone">Tipo de Telefone</label>
                                    <select class="form-select" id="cbbTpTelefone" name="cbbTpTelefone">
                                        <option value="0" selected>Selecione seu Tipo de Telefone...</option>
                                ...
                                <div class="col-sm-4">
                                    <label class="visually-hidden" for="txtTelefone">Telefone</label>
                            ...
                            <div class="row py-1">
                                <div class="col-sm-6">
                                    ...
                                    <input type="password" class="form-control" id="txtSenha" name="txtSenha" placeholder="Defina uma Senha">
                                </div>
                        
                                <div class="col-sm-6">
                                    <label class="visually-hidden" for="txtConfirmarSenha">Confirmar Senha</label>
                                    <input type="password" class="form-control" id="txtConfirmarSenha" name="txtConfirmarSenha" placeholder="Confirme Sua Senha">
                                </div>
                            </div>
    						...
    						<div class="row py-1">
    							<div class="col-sm-6">
	    							<div class="form-check form-switch">
									  <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="swtIsEntrega">
									  <label class="form-check-label" for="flexSwitchCheckDefault">Salvar como endereco de entrega.</label>
									</div>
    							</div>
    							<div class="col-sm-6">
	    							<div class="form-check form-switch">
									  <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="swtIsCobranca">
									  <label class="form-check-label" for="flexSwitchCheckDefault">Salvar como endereco de cobranca.</label>
									</div>
    							</div>
    						</div>
