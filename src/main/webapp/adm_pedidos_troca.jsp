<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import= "java.util.List, dominio.cliente.Cliente, dominio.venda.PedidoTroca, 
...
<body>
    ...
    <header class="navbar navbar-dark bg-dark sticky-top">
          ...
          <ul class="nav col-12 col-lg-auto mx-5 my-2 justify-content-center my-md-0 text-small border-bottom mb-3">
            ...
            <li>
              <a href="/EcomerceLivroLES/adm-pedidos-troca" class="nav-link text-secondary">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#table"></use></svg>
                Trocas
              </a>
            </li>
                      ...
                      <% if(pedidos != null){
                          for(PedidoTroca pedido: pedidos){%>
                            ...
                            <tr>
                             ...
                             <td class="text-center">
                                <%=pedido.getPedido().getStatus().getDescricao()%>
                              </td>
