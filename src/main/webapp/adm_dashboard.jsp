...
<%@page import= "java.util.Map, java.util.TreeMap, java.util.Set"%>
...
<%
	String dados = (String) request.getSession().getAttribute("dados");	
	String labels = (String) request.getSession().getAttribute("txtLabels");	
	String dataSet = (String) request.getSession().getAttribute("dataSet");	
%>
...
<body>
    ...
    <header class="navbar navbar-dark bg-dark sticky-top">
          ...
          <ul class="nav col-12 col-lg-auto mx-5 my-2 justify-content-center my-md-0 text-small border-bottom mb-3">
            ...
            <li>
              <a href="/EcomerceLivroLES/adm-grafico" class="nav-link text-secondary">
...
<hr>
	...
	<div class="row align-items-md-center">
		<div class="col-3">
			<form action="/EcomerceLivroLES/adm-grafico">
      ...
      <div class="row">
        ...
        <hr>
         ...
         <div class="row mb-3">
		    <label for="dtInicio" class="col-sm-4 col-form-label">Data Inicio</label>
		    <div class="col-sm-8">
        ...
        <div class="row mb-3">
		    <label for="dtFim" class="col-sm-4 col-form-label">Data Fim</label>
		    <div class="col-sm-8">
